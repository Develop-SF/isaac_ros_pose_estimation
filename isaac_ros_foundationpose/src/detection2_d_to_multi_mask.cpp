...
*/
class Detection2DToMultiMask : public rclcpp::Node
{
public:
  explicit Detection2DToMultiMask(const rclcpp::NodeOptions & options)
  : Node("detection2_d_to_multi_mask", options)
  {
    ...
    detection2_d_array_sub_ = this->create_subscription<vision_msgs::msg::Detection2DArray>(
      ...
      std::bind(&Detection2DToMultiMask::boundingBoxArrayCallback, this, std::placeholders::_1));
...
RCLCPP_COMPONENTS_REGISTER_NODE(nvidia::isaac_ros::foundationpose::Detection2DToMultiMask)
